...
if __name__ == '__main__':
    t = Certificado()
    t.create_main_text("""Certificamos que Fulana Santos da Silva, CPF 101.555.413-59, participou, como CURSISTA, do Projeto de
...
29/08/2022 a 16/09/2022, com uma carga horária total de 40 horas.""", 40)
